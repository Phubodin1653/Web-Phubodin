...
const socialLinks = [
  {
    ...
    icon: ({ className, ...props }) => (
      ...
      >
        ...
        {/* White chat bubble */}
        <ellipse cx="12" cy="10.5" rx="6.5" ry="5.5" fill="white" />
        
        {/* Bubble pointer */}
        <path d="M 16 14 L 18 17 L 15.5 14.5 Z" fill="white" />
    ...
    url: "https://line.me/ti/p/RLOyomxLjc",
    color: "#00B900",
    gradient: "from-[#00B900] to-[#00C300]",
    isPrimary: true,
  },
  {
    name: "Instagram",
    ...
    subText: "@po_ss06",
    icon: Instagram,
    url: "https://www.instagram.com/po_ss06/",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@phubodin4846",
    icon: Youtube,
    url: "https://www.youtube.com/@phubodin4846",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@phubodin1653",
    icon: Github,
    url: "https://github.com/Phubodin1653",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@ph_ss49",
    color: "black",
...
const SocialLinks = () => {
  const line = socialLinks.find((link) => link.isPrimary);
        ...
        >
          ...
          <div
            className={`absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500
                       bg-gradient-to-r ${line.gradient}`}
          />
