...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Phubodin1653" },
  { icon: ({ className, ...props }) => (
    ...
    >
      <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" fill="#2d1d4b" />
    </svg>
  ), link: "https://line.me/ti/p/RLOyomxLjc" },
  { icon: Instagram, link: "https://www.instagram.com/po_ss06/" }
];
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            <div className="w-full py-[10%] sm:py-0 lg:w-1/2 h-auto lg:h-[600px] xl:h-[750px] relative flex items-center justify-center order-2 lg:order-2 mt-8 lg:mt-0"
              ...
              <div className="relative w-full opacity-90">
                ...
                <div className={`relative lg:left-12 z-10 w-full h-full flex items-center justify-center opacity-90 transform transition-transform duration-500 ${
